...
//        This executes
//          am broadcast co.miescuela.api/.TermuxApiReceiver --es socket_input ${INPUT_SOCKET} 
...
_Noreturn void exec_am_broadcast(int argc, char** argv, char* input_address_string, char* output_address_string)
{
    ...
    child_argv[3] = "0";
    child_argv[4] = "-n";
    child_argv[5] = "co.miescuela.api/.TermuxApiReceiver";
    child_argv[6] = "--es";
    ...
    execv("/data/data/co.miescuela/files/usr/bin/am", child_argv);

    perror("execv(\"/data/data/co.miescuela/files/usr/bin/am\")");
    exit(1);
}
...
_Noreturn void exec_callback(int fd)
{
    ...
    execl("/data/data/co.miescuela/files/usr/libexec/termux-callback", "termux-callback", fds, NULL);
    perror("execl(\"/data/data/co.miescuela/files/usr/libexec/termux-callback\")");
    exit(1);
}
